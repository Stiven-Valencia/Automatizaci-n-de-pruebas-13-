...
| `POST` | `/productos` | `201` · `400` | Crea un producto |
...
> Enviar un precio o stock negativo devuelve `400` con el detalle del error en el cuerpo
> de la respuesta. El controlador captura la `IllegalArgumentException` que lanza el
> servicio y la traduce al código HTTP correcto.
